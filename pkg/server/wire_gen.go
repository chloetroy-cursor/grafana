...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	handoffnotesStore := handoffnotes.ProvideStore(sqlStore)
	handoffnotesService := handoffnotes.ProvideService(handoffnotesStore, userimplService, routeRegisterImpl, accessControl)
